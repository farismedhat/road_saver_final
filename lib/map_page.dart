...
class _MapPageState extends State<MapPage> with TickerProviderStateMixin {
        ...
        if (mounted) {
          setState(() {
            ...
            for (var truck in _chargingTrucks) {
              const radius = 0.001;
              truck['lat'] =
                  truck['baseLat'] + radius * math.cos(_movementAngle);
              truck['lng'] =
                  truck['baseLng'] + radius * math.sin(_movementAngle);
            }
  ...
  Future<String> _getCarType() async {
    ...
    try {
      ...
      String? carType =
          data['car_type'] ?? data['carName'] ?? data['car_model'];
      ...
      if (!opened) {
        ...
        showDialog(
          ...
          builder: (context) => AlertDialog(
            ...
            content: const Text(
                'Please enable location services from device settings and try again.'),
            actions: [
              TextButton(
    ...
    if (permission == LocationPermission.deniedForever) {
      ...
      showDialog(
        ...
        builder: (context) => AlertDialog(
          ...
          content: const Text(
              'Please allow location permission from device settings.'),
          actions: [
            TextButton(
              onPressed: () async {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          _gasStations = elements.map((e) {
            return {
              'name':
                  _gasStationNames[_random.nextInt(_gasStationNames.length)],
              'lat': e['lat'] as double,
              'lng': e['lon'] as double,
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            Text(
                'RoadSaver Charging: ${station['hasRoadSaverCharging'] ? 'Available' : 'Not Available'}'),
        ...
        if (user != null) {
          ...
          showDialog(
            ...
            builder: (context) => AlertDialog(
              title: const Text('Error'),
              content:
                  const Text('You are not logged in. Please log in again.'),
              actions: [
                TextButton(
                  onPressed: () {
                    Navigator.pop(context);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: themeProvider.theme.appBarTheme.elevation,
        leading: IconButton(
          ...
          PopupMenuButton<String>(
            ...
            itemBuilder: (BuildContext context) => <PopupMenuEntry<String>>[
              ...
              PopupMenuItem<String>(
                ...
                child: Row(
                  children: [
                    Icon(Icons.help, color: Colors.greenAccent),
                    const SizedBox(width: 8),
                    ...
                    Marker(
                      ...
                      child: Image.asset(
                        ...
                        errorBuilder: (context, error, stackTrace) {
                          print('Error loading user_location_icon.png: $error');
                          return const Icon(
                            Icons.location_pin,
                            color: Colors.red,
                            size: 40,
